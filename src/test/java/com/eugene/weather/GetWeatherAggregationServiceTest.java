...
class GetWeatherAggregationServiceTest extends BaseTest {
    ...
    void testGetsAverageBetweenDates() {
        ...
        mockRepositoryGetSensorData(id,
                Map.of(firstDate, createSensorDayData(10.0, 1),
                        secondDate, createSensorDayData(20.0, 1)));
    ...
    void testGetReturnsNanWhenStartDateIsBiggerThatEndDate() {
        ...
        mockRepositoryGetSensorData(id,
                Map.of(startDate.toString(), createSensorDayData(10.0, 1),
                        endDate.toString(), createSensorDayData(20.0, 1)));
    ...
    void testGetDoesNotIncludeDatesOutLimit() {
        ...
        LocalDate endDate = LocalDate.parse(secondDate).plusDays(1);
        mockRepositoryGetSensorData(id,
                Map.of(firstDate, createSensorDayData(10, 1),
                        secondDate, createSensorDayData(20, 1),
                        thirdDate, createSensorDayData(30, 1)));
        ...
        Mockito.when(repositoryMock.getAllSensorsData())
                .thenReturn(List.of(
                        new SensorData("firstSensor", Map.of(
                                firstDate, createSensorDayData(5, 1),
                                secondDate, createSensorDayData(15, 1),
                                thirdDate, createSensorDayData(30, 1)
                        )),
                        new SensorData("secondSensor", Map.of(
                                firstDate, createSensorDayData(20, 1),
                                secondDate, createSensorDayData(30, 1),
                                thirdDate, createSensorDayData(40, 1)
                        ))));
    ...
    void testGetAllReturnsNanWhenStartDateIsBiggerThatEndDate() {
        ...
        Mockito.when(repositoryMock.getAllSensorsData())
                .thenReturn(List.of(
                        new SensorData("firstSensor", Map.of(
                                startDate.toString(), createSensorDayData(5, 1)))));
